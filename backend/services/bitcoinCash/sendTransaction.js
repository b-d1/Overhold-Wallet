...
let providerFunctions = {
    bitprim: sendBitprimTransaction
};


async function sendBitprimTransaction(userCoin, transactionInfo, generateAddress, pName) {
    ...
    let urls = {
        utxo: `${providers.bitcoinCash.bitprim.getUTXO}`,
        broadcastTransaction: `${providers.bitcoinCash.bitprim.sendTx}`
    };
    ...
    transaction.transactionHash = transaction.transactionHash.result;
