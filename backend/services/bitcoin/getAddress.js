...
let info = require('../../data/templates');
let errorMessages = require('../../data/messages').generalErrors;
    ...
    function generateAddresses (num, seed, addressIndex, change) {
        ...
        addressObj.coinType = dataUtils.coinType.Bitcoin;
        addressObj.change = change;

        let root = bitcoin.HDNode.fromSeedHex(seed, bitcoin.networks.bitcoin);
        ...
        for (let i = 0; i < num; i++) {
            ...
            let addressBalance = Object.assign({}, info.AddressBalance);
