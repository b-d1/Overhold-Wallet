...
let providerFunctions = {
    ...
    insight: getOverholdInsightTransactions,
	blockcypher: dashBlockcypherGetTransactions
};
...
async function getOverholdInsightTransactions(obj, addresses, pName) {
	...
	let results =  providers.requests.postRequest(requestBody, providers.dash[pName].getTx);
...
async function dashBlockcypherGetTransactions(obj, addresses, pName){
    let results = providers.requests.getRequestParam(addresses, providers.dash.blockcypher.getTx, 'full');
